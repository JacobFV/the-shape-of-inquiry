...
//
// Order: alphabetical by first author. All entries below are cited inline
// somewhere in the body; if a future edit removes a citation, leave the
// orphaned entry at the end of the list, after the cited block.
...
export const bibliographyLines: readonly string[] = [
  ...
  "\\newblock \\emph{PLOS Computational Biology}, 19(10), e1011465.",
  "",
  ...
  "Burger, B., Maffettone, P. M., Gusev, V. V., et al. (2020).",
  "\\newblock A mobile robotic chemist.",
  "\\newblock \\emph{Nature}, 583, 237--241.",
  "",
  ...
  "\\newblock \\emph{Advances in Neural Information Processing Systems}, 31, 2451--2463.",
  "",
  ...
  "\\newblock In \\emph{Proceedings of the IEEE Congress on Evolutionary Computation}, pages 128--135.",
  "",
  "\\bibitem[Manheim and Garrabrant(2018)]{manheim2018}",
  ...
  "\\newblock \\emph{International Conference on Machine Learning}, 70, 2778--2787.",
  "",
  ...
  "\\newblock In \\emph{From Animals to Animats: Proceedings of the First International Conference on Simulation of Adaptive Behavior}, pages 222--227. MIT Press.",
  "",
  ...
  "\\newblock In \\emph{37th Annual Allerton Conference on Communication, Control, and Computing}, pages 368--377.",
  "",

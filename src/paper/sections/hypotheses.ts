...
export const hypothesesLines: readonly string[] = [
  ...
  "",
  "Under neutral conditions, a event-geometric agent should enter measurement-construction loops more often than a role-prompted agent or a task-reward agent \\citep{oudeyer2007,suttonbarto2018}.",
  "",
  "Neutral condition:",
  "\\begin{quote}",
  ...
  "",
  "Agents with raw sensor access and code tools should invent reusable measurement routines more often than agents with semantic perception alone. Reuse matters. A one-off trick is less interesting than a procedure that lowers the cost of future uncertainty reduction \\citep{schmidhuber2010}.",
  "",

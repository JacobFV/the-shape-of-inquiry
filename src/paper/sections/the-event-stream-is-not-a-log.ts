...
export const theEventStreamIsNotALogLines: readonly string[] = [
  ...
  "\\end{lstlisting}",
  "",
  "The event history is autobiography, audit trail, training corpus, and causal graph in the sense of \\citet{pearl2009}. A claim unsupported by event pointers remains narration, not knowledge.",
  "",
  "\\subsection{Streams}",
  "",
  ...
  "\\end{equation}",
  "This is the practical form of humility, and the operational counterpart of the good-regulator theorem \\citep{conantashby1970}: the agent should not only model the world; it should model the shape of its own unreliability inside the world.",
  "",

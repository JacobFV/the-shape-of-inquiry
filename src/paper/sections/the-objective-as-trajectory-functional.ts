...
export const theObjectiveAsTrajectoryFunctionalLines: readonly string[] = [
  ...
  "\\end{align}",
  "The terms are information gain, self-effect, calibration improvement, affordance expansion, creative compression, integration maintained through perturbation, inhibition-coefficient flexibility, replay auditability, unsafe-action risk, cost, proxy exploitation in the sense of \\citet{manheim2018}, and unsupported semantic performance.",
  "",
  ...
  "",
  "First, train a differentiable event-world model in the spirit of \\citet{ha2018,hafner2020,muzero2020}:",
  "\\begin{equation}",
